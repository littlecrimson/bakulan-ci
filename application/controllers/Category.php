...
class Category extends MY_Controller {
    ...
    public function index($page = NULL)
    {
        ...
        $data['content'] = $this->category->paginate($page)->all();
    ...
    public function create()
    {
        ...
        if($this->category->create($input)){
            ...
            $this->session->set_flashdata('error', 'Oopss.. terjadi kesalahan !');
        }
    ...
    public function unique_slug(){
        ...
        $category = $this->category->where('slug',$slug)->single();
    ...
    {
        $data['content'] = $this->category->where('id',$id)->single();
        ...
        if ($this->category->where('id',$id)->update($data['input'])) {
            ...
            $this->session->set_flashdata('error', 'Gagal melakukan perubahan!');
        }
    ...
    public function delete($id)
    {
        ...
        if(!$this->category->where('id',$id)->single()){
            $this->session->set_flashdata('warning', 'Maaf, data tidak ditemukan!');
            redirect(base_url('category'));
        }
    ...
    public function search($page = null)
    {
        ...
        $data['title']  = 'Pencarian: category';
        $data['content'] = $this->category->like('title',$keyword)->paginate($page)->all();
