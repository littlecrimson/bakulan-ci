                ...
                <div class="card-body">
                    ...
                    <?= isset($input->id) ? form_hidden('id',$input->id) : '' ?>
                        <div class="form-group">
                            ...
                            <!-- <input type="text" id="title" name="nama" class="form-control" onkeyup="createSlug()" required autofocus> -->
                            <?= form_input('title',$input->title,['class'=>'form-control','id'=>'title','onkeyup' => 'createSlug()', 'required' => true, 'autofocus' => true]) ?>
                            <!-- <small class="form-text text-danger">Nama produk harus diisi</small> -->
                            <?= form_error('title') ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <input type="file" name="image" style="display: block" id="img_input">
                                <br>
                                <?php if($this->session->flashdata('image_error')) : ?>
                                <small class="form-text text-danger"><?= $this->session->flashdata('image_error') ?></small>
                                <?php endif; ?>
                                <?php if($input->image) : ?>
                                    <img src="<?= base_url("/images/product/$input->image") ?>" class="img-fluid" id="img_show">
                                <?php endif; ?>
                            </div>
                            <div class="form-group">
